...
#     def list(self, **kw):
#         return http.request.render('interest_calc.listing', {
#             'root': '/interest_calc/interest_calc',
#             'objects': http.request.env['interest_calc.interest_calc'].search([]),
#         })

#     @http.route('/interest_calc/interest_calc/objects/<model("interest_calc.interest_calc"):obj>/', auth='public')
#     def object(self, obj, **kw):
#         return http.request.render('interest_calc.object', {
#             'object': obj
#         })